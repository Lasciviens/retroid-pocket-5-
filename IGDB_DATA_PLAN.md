...
1. mevcut canli schema uzerinde `storyline`, `publisher`, `igdb_url`, `igdb_rating`, `igdb_synced_at` alanlarini korumak ve normalize etmek
...
5. ayni isim / farkli platform oyunlari icin canonical + platform_variants modeli
6. tum IGDB import akislarinda ortak field seti ve query kaliplari korunur
