-- migration_v12.sql
-- v_games_full view: games.developer kolonu çıkarıldı
-- Bir sonraki adım (kolon drop) Codex UI tarafını temizledikten sonra yapılacak

DROP VIEW IF EXISTS public.v_games_full;

CREATE VIEW public.v_games_full AS
SELECT
  g.id, g.title, g.release_year, g.publisher,
